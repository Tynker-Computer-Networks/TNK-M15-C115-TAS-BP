...
# Define move_player() method that takes steps and color

    # Access left and right boxes as global
    
    
    # Check if color is red 
    
         # Set boxes to left_boxes
         
    # Else
    
         # Set boxes to right_boxes
         
    
    # Select the box at index steps and configure it to update the bg color to color variable
...
def received_msg():
    ...
    while True:
        ...
        # Check if 'player1_turn' exits in message
        
            # Set color of dice to yellow
            
            # Call move_player() with dice_value and color 'yellow'
            


        # Check if 'player2_turn' exits in message
        
            # Set color of dice to red
            
            # Call move_player() with dice_value and color 'red'
