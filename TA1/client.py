...
def received_msg():
    ...
    while True:
        ...
        # Check if player1_turn or player2_turn in message
        
            # Create dice_choices list with list of dice options as '⚀','⚁','⚂','⚃','⚄','⚅'
            
            # Find index of message[0] in dice_choices and add 1 to it to get dice_value
